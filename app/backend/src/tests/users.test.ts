...
Sinon.restore();
  ...
  //     it('estando correto retorna status code 200', async () =>{
  //         chaiHttpResponse = await chai.request(app)
  //         .get('/login/validate').auth(userLoginMock.email, ' eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFkbWluQGFkbWluLmNvbSIsInBhc3N3b3JkIjoic2VjcmV0X2FkbWluIiwiaWF0IjoxNjYwOTQ3NTE5fQ.wMKsT6UWRcjOKdSVIKexpUQcxfat21yz2rqbu64QsUU')

  //         console.log(chaiHttpRequest)
